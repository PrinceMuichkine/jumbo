        ...
        <Panel defaultSize={showTerminal ? DEFAULT_EDITOR_SIZE : 100} minSize={20}>
          <PanelGroup direction="horizontal">
            <Panel defaultSize={20} minSize={10} collapsible>
              <div className="flex flex-col border-r border-jumbo-elements-borderColor h-full">
                <PanelHeader>
        ...
        >
          <div className="h-full">
            <div className="bg-jumbo-elements-terminals-background h-full flex flex-col">
              <div className="flex items-center bg-jumbo-elements-background-depth-2 border-y border-jumbo-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  return (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-jumbo-elements-terminals-buttonBackground text-jumbo-elements-textPrimary': isActive,
                          'bg-jumbo-elements-background-depth-2 text-jumbo-elements-textSecondary hover:bg-jumbo-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
