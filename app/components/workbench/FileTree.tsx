  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-jumbo-elements-item-contentDefault hover:text-jumbo-elements-item-contentActive hover:bg-jumbo-elements-item-backgroundActive':
          !selected,
  ...
  return (
    <NodeButton
      ...
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-jumbo-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
