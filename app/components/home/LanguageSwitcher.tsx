...
export const LanguageSwitcher = memo(({
  ...
  const toggleLanguage = useCallback((e: React.MouseEvent) => {
    ...
    setLanguage(nextLang as any); // Type casting as Language type
    ...
    >
      <div className="relative w-[70px] h-[16px] overflow-visible">
        <AnimatePresence mode="wait" initial={false}>
          <motion.span
            key={currentLanguage}
            className="absolute inset-0 flex items-center justify-start whitespace-nowrap truncate translate-y-[1px]"
