[![Jumbo Open Source Codebase](./public/social_preview_index.jpg)](https://jumbo.dev)
...
### What’s the Difference Between Jumbo (This Repo) and [Jumbo](https://jumbo.dev)?

- **Jumbo**: This is the **commercial product** from StackBlitz—a hosted, browser-based AI development tool that enables users to prompt, run, edit, and deploy full-stack web applications directly in the browser. Built on top of the [Jumbo open-source repo](https://github.com/lomi./jumbo.dev) and powered by the lomi. **WebContainer API**.

- **Jumbo (This Repo)**: This open-source repository provides the core components used to make **Jumbo**. This repo contains the UI interface for Jumbo as well as the server components, built using [Remix Run](https://remix.run/). By leveraging this repo and StackBlitz’s **WebContainer API**, you can create your own AI-powered development tools and full-stack applications that run entirely in the browser.
